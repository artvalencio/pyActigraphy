...
class GenContactDevice(ContactRecording):
    r"""Generic contact acquisition device
...
def read_raw_gcd(
    ...
    r"""Reader function for generic contact device file.
    ...
    Returns
    -------
    raw : Instance of GenContactDevice
        An object containing raw GLD data
    """

    return GenContactDevice(
        input_fname,
        channels=channels,
        rsfreq=rsfreq,
        agg=agg,
